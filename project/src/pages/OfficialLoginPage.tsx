    ...
    try {
      ...
      if (data.user) {
        ...
        if (official) {
          ...
          setError('This account is not registered as an official. Please use the regular login if you are a user.');
        }
      }
    } catch (err: any) {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
            >
